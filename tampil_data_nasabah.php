                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="jenis_pembiayaan">
                                ...
                                foreach ($jenis_pembiayaan as $value) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="angunan/jaminan">
                                <?php
                                foreach ($agunanjaminan as $value) {
                                    echo '<option>' . $value . '</option>';
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="total_penghasilan">
                                <?php
                                foreach ($total_penghasilan as $value) {
                                    echo '<option>' . $value . '</option>';
                                }
                                ?>
                            </select>
